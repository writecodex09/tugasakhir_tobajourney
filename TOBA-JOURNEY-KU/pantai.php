...
<html>
  ...
  <tbody>
<?php
    foreach($checkdata_pantai as $checkdata_pantai_final => $checkdata_pantai_value) {

   
?>
    <tr>    
       <td><?php echo $checkdata_pantai_value['nama_pantai']; ?></td>  
      <td><?php echo $checkdata_pantai_value['lokasi_pantai']; ?></td>
      <td><?php echo $checkdata_pantai_value['deskripsi_pantai']; ?></td>
      <td>
