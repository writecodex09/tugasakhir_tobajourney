...
<html>
  ...
  <tbody>
<?php
    foreach($checkdata_kebudayaan as $checkdata_kebudayaan_final => $checkdata_kebudayaan_value) {

   
?>
    <tr>    
       <td><?php echo $checkdata_kebudayaan_value['nama_Kebudayaan']; ?></td>  
      <td><?php echo $checkdata_kebudayaan_value['lokasi_Kebudayaan']; ?></td>
      <td><?php echo $checkdata_kebudayaan_value['deskripsi_Kebudayaan']; ?></td>
      <td>
