...
<html>
  ...
  <tbody>
<?php
    foreach($checkdata_hotel as $checkdata_hotel_final => $checkdata_hotel_value) {

   
?>
    <tr>    
       <td><?php echo $checkdata_hotel_value['nama_hotel']; ?></td>  
      <td><?php echo $checkdata_hotel_value['lokasi_hotel']; ?></td>
      <td><?php echo $checkdata_hotel_value['deskripsi_hotel']; ?></td>
      <td>
