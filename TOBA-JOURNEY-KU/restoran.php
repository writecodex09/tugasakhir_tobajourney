...
<html>
  ...
  <tbody>
<?php
    foreach($checkdata_restoran as $checkdata_restoran_final => $checkdata_restoran_value) {

   
?>
    <tr>    
       <td><?php echo $checkdata_restoran_value['nama_Restoran']; ?></td>  
      <td><?php echo $checkdata_restoran_value['lokasi_Restoran']; ?></td>
      <td><?php echo $checkdata_restoran_value['deskripsi_Restoran']; ?></td>
      <td>
