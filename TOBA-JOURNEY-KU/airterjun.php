...
<html>
  ...
  <tbody>
<?php
    foreach($checkdata_airterjun as $checkdata_airterjun_final => $checkdata_airterjun_value) {

   
?>
    <tr>    
       <td><?php echo $checkdata_airterjun_value['nama_AirTerjun']; ?></td>  
      <td><?php echo $checkdata_airterjun_value['lokasi_AirTerjun']; ?></td>
      <td><?php echo $checkdata_airterjun_value['deskripsi_AirTerjun']; ?></td>
      <td>
