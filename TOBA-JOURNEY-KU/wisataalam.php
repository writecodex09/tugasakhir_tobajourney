...
<html>
  ...
  <tbody>
<?php
    foreach($checkdata_wisataalam as $checkdata_wisataalam_final => $checkdata_wisataalam_value) {

   
?>
    <tr>    
       <td><?php echo $checkdata_wisataalam_value['nama_WisataAlam']; ?></td>  
      <td><?php echo $checkdata_wisataalam_value['lokasi_WisataAlam']; ?></td>
      <td><?php echo $checkdata_wisataalam_value['deskripsi_WisataAlam']; ?></td>
      <td>
