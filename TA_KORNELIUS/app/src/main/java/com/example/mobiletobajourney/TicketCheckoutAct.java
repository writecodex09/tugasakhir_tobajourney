...
public class TicketCheckoutAct extends AppCompatActivity {
    ...
    TextView textjumlahtiket, texttotalharga, textmybalance, nama_wisata, lokasi_wisata, fasilitas_wisata, deskripsi_wisata;
    ...
    // karena ingin membuat transaksi secara unik jadi berbeda - beda
...
//        valuetotalharga = valuehargatiket * valuejumlahtiket;
        ...
        textmybalance.setText("IDR "+ mybalance+"");
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                deskripsi_wisata.setText(dataSnapshot.child("deskripsi_wisata").getValue().toString());

                tanggal_wisata = dataSnapshot.child("tanggal_wisata").getValue().toString();


                valuehargatiket = Integer.valueOf(dataSnapshot.child("harga_wisata").getValue().toString());
//                mybalance = Integer.valueOf(dataSnapshot.child("user_balance").getValue().toString());
            ...
            public void onClick(View v) {
                ...
                reference3.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        reference3.getRef().child("lokasi_wisata").setValue(lokasi_wisata.getText().toString());
                        reference3.getRef().child("fasilitas_wisata").setValue(fasilitas_wisata.getText().toString());
                        reference3.getRef().child("deskripsi_wisata").setValue(deskripsi_wisata.getText().toString());
